  ...
  return (
    <div className="min-h-screen bg-[#0f0f13] flex items-center justify-center px-4">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] right-[-5%] w-96 h-96 bg-violet-600 opacity-20 rounded-full blur-[120px]" />
        <div className="absolute bottom-[-10%] left-[-5%] w-96 h-96 bg-indigo-500 opacity-20 rounded-full blur-[120px]" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-[#16161d] border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-white/40 mt-1">Sign in to your TaskTable account</p>
          </div>
